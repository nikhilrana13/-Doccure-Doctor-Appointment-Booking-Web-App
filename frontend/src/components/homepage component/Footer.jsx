    ...
    return (
        <footer className="w-full">
            <div className="mx-auto  max-w-7xl ">
                {/*Grid*/}
                <div className="grid bg-[#F6FAFF] dark:bg-black p-5 grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        <NavLink to="/" className="">
                            <img src={logo} className="w-70 h-10" alt="logo" />
                        </NavLink>
                        <p className="py-8 text-sm font-[500] text-[#465D7C] lg:max-w-xs  lg:text-left">
                        ...
                        <NavLink
                            to="#"
                            className="px-5 py-2.5 rounded-full text-white text-sm cursor-pointer tracking-wider font-medium  border-current outline-none bg-gradient-to-tr hover:bg-gradient-to-tl from-blue-700 to-blue-400"
                        >
                            Contact us
                        </NavLink>
                    </div>
                    ...
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg dark:text-white text-[#012047] font-medium mb-7">Company</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6">
                                <a
                                    href="/"
                                    className="text-gray-600 dark:text-white font-[500] "
                                >
                                    Home
                                </a>
                            </li>
                    ...
                    {/*End Col*/}
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-black dark:text-white font-medium mb-7">Specialities</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6">
                                <a
                                    href="javascript:;"
                    ...
                    {/*End Col*/}
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-black dark:text-white font-medium mb-7">Contact Us</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6">
                                <a
                                    href="javascript:;"
                    ...
                    {/*End Col*/}
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-black dark:text-white font-medium mb-7">Subscribe</h4>
                        <p className="text-sm text-gray-500 dark:text-white font-[500] leading-6 mb-7">
                ...
                {/*Grid*/}
                <div className="py-7 bg-[#E2EDFF] dark:bg-black p-5">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-[#465D7C] dark:text-white font-[500] ">
                            ©<NavLink href="/">Doccure</NavLink> Made with ❤️ by Nikhil Rana
