...
const DoctorProfileCard = () => {
  ...
  <div class="rounded-lg  bg-white dark:bg-black px-4 p-5  shadow-lg">
    <div class="relative mx-auto w-24 h-24 rounded-full">
      ...
      <img class="mx-auto w-full h-full rounded-full" src={user?.profilepic || "https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3NMWlJ2O7OqJz2UcJwW.jpg"} alt="profile image" />
    </div>
    <div className='flex flex-col gap-1'>
    <h1 class="my-1 text-center text-xl font-bold leading-8 dark:text-white text-gray-900">{user?.name}</h1>
    <h3 class="font-lg text-semibold text-center leading-6 dark:text-white text-gray-600">Doctor Id :{user?._id.slice(0,8)}</h3>
    </div>
